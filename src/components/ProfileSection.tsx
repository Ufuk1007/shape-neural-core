...
const ProfileSection = () => {
  return (
    <section className="relative min-h-screen bg-[#0a0a0a] overflow-hidden">
      ...
      <div className="relative z-20 max-w-6xl mx-auto px-8 py-24">
        {/* Section Header */}
        <div className="mb-16">
          <span className="text-[#0f0] font-mono text-sm tracking-[0.3em] opacity-60">
            {'>'} ACCESSING_PROFILE...
          </span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          ...
          <div className="space-y-8">
            {/* Header */}
            <h2 className="text-[#0f0] font-mono text-xl tracking-[0.2em]">
            ...
            <div className="font-mono space-y-3 text-lg">
              <div className="flex">
                ...
                <span className="text-gray-400 w-20">IDENT:</span>
                <span className="text-white tracking-wider">UFUK AVCI</span>
              </div>
              <div className="flex">
                <span className="text-[#0f0] mr-2">{'>'}</span>
                <span className="text-gray-400 w-20">ROLE:</span>
                <span className="text-white tracking-wider">CX_SPECIALIST && AI_ARCHITECT</span>
              </div>
              <div className="flex">
                <span className="text-[#0f0] mr-2">{'>'}</span>
              ...
              <div className="flex">
                ...
                <span className="text-white tracking-wider">BRIDGING_ANALOG_AND_SYNTHETIC</span>
              </div>
            </div>

            {/* Manifesto Block */}
            <div className="mt-12 border-l-2 border-[#333] pl-6">
              <div className="text-[#0f0] font-mono text-xs tracking-[0.2em] mb-4 opacity-60">
                {'>'} MANIFESTO.TXT
              </div>
              <p className="text-gray-400 font-mono text-base leading-relaxed italic">
        ...
        <footer className="text-center font-mono">
          ...
          <div className="flex justify-center gap-8 mb-8">
            <a 
              ...
              className="group flex items-center gap-2 text-gray-500 hover:text-[#0f0] transition-colors duration-300"
            >
            ...
            <a 
              ...
              target="_blank" 
              rel="noopener noreferrer"
              className="group flex items-center gap-2 text-gray-500 hover:text-[#ff0055] transition-colors duration-300"
            >
          ...
          {/* Copyright */}
          <div className="text-gray-600 text-sm tracking-[0.2em]">
