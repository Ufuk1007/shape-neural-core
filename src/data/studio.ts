...
export const STUDIO_OFFERS: StudioOffer[] = [
  {
    ...
    duration: { de: "Typisch 1–2 Wochen", en: "Typically 1–2 weeks" },
    price: { de: "Orientierung: 2.900–6.500 € netto", en: "Guide: €2,900–€6,500 excl. VAT" },
    prerequisites: { de: "Ein klarer Arbeitskontext, Zugang zu den genutzten Werkzeugen und eine verantwortliche Ansprechperson.", en: "A clear work context, access to the tools in use and one accountable contact." },
  ...
  },
  {
    ...
    duration: { de: "Typisch 3–6 Wochen", en: "Typically 3–6 weeks" },
    price: { de: "Orientierung: 7.500–18.000 € netto", en: "Guide: €7,500–€18,000 excl. VAT" },
    prerequisites: { de: "Ein priorisierter Ablauf, verfügbare Fachexpertise und Zugriff auf relevante Systeme oder Beispieldaten.", en: "One prioritised workflow, available domain expertise and access to relevant systems or representative data." },
    ...
    boundaries: {
      de: ["Keine offene Transformation über mehrere Workflows", "Keine ERP- oder Kernsystemmigration", "Keine produktionskritische 24/7-Verantwortung"],
      en: ["No open-ended transformation across multiple workflows", "No ERP or core-system migration", "No production-critical 24/7 responsibility"],
    },
    proof: "example",
  },
  {
    ...
    duration: { de: "Typisch 3–5 Wochen", en: "Typically 3–5 weeks" },
    price: { de: "Orientierung: 9.500–22.000 € netto", en: "Guide: €9,500–€22,000 excl. VAT" },
    prerequisites: { de: "Eine konkrete Produktfrage, erreichbare Testpersonen oder reale Nutzungssituationen und schnelle Entscheidungen.", en: "One concrete product question, access to test users or real usage situations and timely decisions." },
