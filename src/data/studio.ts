...
export const STUDIO_OFFERS: StudioOffer[] = [
  {
    ...
    question: { de: "Ich will KI endlich sinnvoll einsetzen.", en: "I want to put AI to useful work." },
  ...
  },
  {
    ...
    question: { de: "Ich will einen Prozess neu denken.", en: "I want to rethink a workflow." },
  ...
  },
  {
    ...
    question: { de: "Ich habe eine KI-Idee, die ich testen will.", en: "I have an AI idea I want to test." },
